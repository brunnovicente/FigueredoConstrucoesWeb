...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'categoria' => ['type' => 'string', 'length' => 30, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'status' => 1,
                'created' => '2020-04-10 04:32:24',
                'modified' => '2020-04-10 04:32:24',
            ],
        ];
        parent::init();
    }
